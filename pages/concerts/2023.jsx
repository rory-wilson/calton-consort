        ...
        <Col md={10} sm={12}>
          <section className="padded">
            ...
            <Concert title="A Boy Was Born" imgUrl="/static/flyers/2023_12_a_boy_was_born.png" date="9 Dec">
              Herbert Howells	<i>Long, Long Ago</i><br /> 
              Benjamin Britten <i>A Boy Was Born</i><br />
              Kerensa Briggs <i>A Tender Shoot</i><br />
              Tamsin Jones <i>Noel: Verbum Caro Factum Est</i><br />
              Chris Hutchings<i> Balulalow</i><br />
              Herbert Howells <i>Sing Lullaby</i>
            </Concert>
            <Concert title="O Bone Jesu" imgUrl="/static/flyers/2023_11 o bone jesu.png" date="4 Nov">
            Hildegard of Bingen	<i>O Pastor Animarum</i><br />
            Robert Carver		<i>O Bone Jesu</i><br />
            Henry Purcell		<i>Funeral Sentences</i><br />
            Eleanor Haward		<i>O Pastor Animarum (* Premiere)</i><br />
            James MacMillan	<i>O Bone Jesu</i><br />
